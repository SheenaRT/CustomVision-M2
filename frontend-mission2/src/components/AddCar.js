...
function AddCar() {
  ...
  const [isAdded, setIsAdded] = useState(false); // State for tracking successful addition
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsAdded(true); // Set the added success flag
    } catch (error) {
      console.error(error);
      setIsAdded(false); // Set the added success flag to false on error
    }
  };
